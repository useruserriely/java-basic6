...
//        p2.name = "홍길순";
        ...
        p1.initialize(27, "홍길동");
        p2.initialize(25, "홍길순");
...
//
        ...
        c1.initialize("소나타", "하얀색", 100);
        c2.initialize("모닝", "검정색", 70);
        ...
        cat1.initialize("소나타", "하얀색", 100);
        cat2.initialize("모닝", "검정색", 70);
        ...
        w1.attack(); // 이순신이 20의 데미지를 입힌다.
        w2.attack(); // 강감찬이 15의 데미지를 입힌다.
...
class Car {
    ...
    public void initialize(String model, String color, int speed) {
        this.model = model;
        this.color = color;
        this.speed = speed;
    }
...
class Cat {
    ...
    public void initialize(String name, String kind, int age) {
        this.name = name;
        this.kind = kind;
        this.age = age;
    }
